...
WB_FIELDS_ORDERED_WITH_DESCRIPTION = (
    ...
    ('field_metadata_title',BLANK_DESCRIPTION),
    ('id',BLANK_DESCRIPTION),
    ('parent_id',BLANK_DESCRIPTION),
    ('field_weight',BLANK_DESCRIPTION),
    ('field_display_hints',BLANK_DESCRIPTION),
    ('field_alternative_title',BLANK_DESCRIPTION),
    ('field_subtitle',BLANK_DESCRIPTION),
    ('field_linked_agent',BLANK_DESCRIPTION),
    ...
    ('field_speaker_affiliation',BLANK_DESCRIPTION),
    ('field_family',BLANK_DESCRIPTION),
    ('field_description_long','Scope and Contents-style description'),
    ('field_conference',BLANK_DESCRIPTION),
    ('field_table_of_contents',BLANK_DESCRIPTION),
    ('field_note','Additional note, e.g. caveats about scanning or metadata quality'),
    ('field_biographical_note',BLANK_DESCRIPTION),
    ('field_genre',BLANK_DESCRIPTION),
    ('field_physical_form',BLANK_DESCRIPTION),
    ...
    ('field_subject',BLANK_DESCRIPTION),
    ('field_cnair_subject','Controlled vocabulary: consult vocabularies/cnair_subject.csv, Airtable, or Indigenous Subject Guide'),
    ('field_local_subject',BLANK_DESCRIPTION),
    ('field_subject_olac','Legacy CNAIR only. Not for new materials.'),
    ('field_subjects_name',BLANK_DESCRIPTION),
    ('field_geographic_subject','Consult Library of Congress'),
    ('field_coordinates',BLANK_DESCRIPTION),
    ('field_temporal_subject',BLANK_DESCRIPTION),
    ('field_language','Enter an ISO639 language name OR code'),
    ('field_olac_discourse_type',BLANK_DESCRIPTION),
    ('field_olac_linguistic_type',BLANK_DESCRIPTION),
    ('field_place2',BLANK_DESCRIPTION),
    ('field_publisher',BLANK_DESCRIPTION),
    ('field_place_published',BLANK_DESCRIPTION),
    ('field_extent','Autogenerated if possible. Recount manually if scans include blank pages.'),
    ('field_legacy_identifier',BLANK_DESCRIPTION),
    ...
    ('field_legacy_type',BLANK_DESCRIPTION),
    ('field_classification',BLANK_DESCRIPTION),
    ('field_edition',BLANK_DESCRIPTION),
    ...
    ('field_restrictions_on_access',BLANK_DESCRIPTION),
    ...
    ('field_access_restricted',BLANK_DESCRIPTION),
    ('field_mods_subject_displaylabel',BLANK_DESCRIPTION),
    ('field_administrative_notes','Internal (non-public) note'),
    ('field_access_terms','See documentation here: https://americanphilosophicalsociety.github.io/APS_digitization/metadata/#access-control. Correct value will be filled in automatically for audio.'),
    ('TEI',BLANK_DESCRIPTION),
...
# field_access_terms and field_model always come in a group
